import numpy as np
from ...models.SatModels.SatModel2_symbolic import SaturationModel2_sym
from ...models.SatModels.SatModel2 import SatModelDataClass2

# from ...models.PowerLosses.LossModel2  import GenDataClass2, GeneratorModel2, GeneratorModel2_If_in
# from ...models.CapabilityDiagram import CapabilityDataClass1, CapabilityDiagram1, CapabilityDiagram1Approx
...
gd = {"S_n_mva": 103, 'V_nom_kV': 11, 'cos_phi': 0.9, "I_f_base": 525.15, "R_a_nom": 0.00182, "R_f_nom": None, "X_d_u": 1.059, "X_q_u": 0.676, "X_l": 0.08, 
      "V_nom": 1.0, "I_fd_pu_nom": 1065/525.15, "P_sn_kW": 276.62, "P_rn_kW": 175.78, "P_exn_kW": 15.88, "P_cn_kW": 211.92, "P_const_kW": 413.82, 
...
sat_model_103 = SaturationModel2_sym(sat_model_data_103)
...
Gen103MVA_sat_model_sym = sat_model_103 
