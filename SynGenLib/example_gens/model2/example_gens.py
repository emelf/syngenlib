import numpy as np
from ...models.SatModels.SatModel2 import SaturationModel2, SatModelDataClass2
...
gd = {"S_n_mva": 103, 'V_nom_kV': 11, 'cos_phi': 0.9, "I_f_base": 525.15, "R_a_nom": 0.00182, "R_f_nom": None, "X_d_u": 1.059, "X_q_u": 0.676, "X_l": 0.08, 
      ...
      "SG10": SG10, "SG12": SG12, "P_min": 1e-3, "P_max": 1.0}
...
GenCD_data = CapabilityDataClass1(P_lims=(gd["P_min"], gd["P_max"]), X_d=gd["X_d_u"], X_q=gd["X_q_u"], R_a=gd["R_a_nom"])
...
Gen103MVA_CD_approx = CapabilityDiagram1Approx(Gen103MVA_CD, N_points=10)
