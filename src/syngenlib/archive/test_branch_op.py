...
op1 = BranchOperatingPoint(P_mw=24.793686423, Q_mvar=-2.052793948, V_pu=1.0) 
op2 = BranchOperatingPoint(P_mw=24.763759045, Q_mvar=-2.136307742, V_pu=1.0) 
op3 = BranchOperatingPoint(P_mw=24.795781611, Q_mvar=-1.76737924 , V_pu=1.0) 
op4 = BranchOperatingPoint(P_mw=24.725730924, Q_mvar=-2.551981580, V_pu=1.0) 
op5 = BranchOperatingPoint(P_mw=24.825984243, Q_mvar=-1.374348229, V_pu=1.0) 
op6 = BranchOperatingPoint(P_mw=24.808756171, Q_mvar=-1.607683499, V_pu=1.0) 
op7 = BranchOperatingPoint(P_mw=24.763759044, Q_mvar=-2.136307742, V_pu=1.0) 
op8 = BranchOperatingPoint(P_mw=24.731010813, Q_mvar=-2.495154196, V_pu=0.92) 
op9 = BranchOperatingPoint(P_mw=24.771259162, Q_mvar=-2.052037273, V_pu=0.92)  
...
res_1 = gm_1._calculate_branch_results_from_branch_op(op1)
res_2 = gm_2._calculate_branch_results_from_branch_op(op2)
res_3 = gm_3._calculate_branch_results_from_branch_op(op3)
res_4 = gm_4._calculate_branch_results_from_branch_op(op4)
res_5 = gm_5._calculate_branch_results_from_branch_op(op5)
res_6 = gm_6._calculate_branch_results_from_branch_op(op6)
res_7 = gm_7._calculate_branch_results_from_branch_op(op7)
res_8 = gm_8._calculate_branch_results_from_branch_op(op8)
res_9 = gm_9._calculate_branch_results_from_branch_op(op9)

def print_results(res: GeneratorBranchResults, sol: GeneratorBranchResults):
...
if __name__ == "__main__":
    ...
    print_results(res_1, sol_1)
    print_results(res_2, sol_2)
    print_results(res_3, sol_3)
    print_results(res_4, sol_4)
    print_results(res_5, sol_5)
    print_results(res_6, sol_6)
    print_results(res_7, sol_7)
    print_results(res_8, sol_8)
    print_results(res_9, sol_9)