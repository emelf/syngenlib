...
gen_data = GeneratorDataclass(S_n_mva=S_nom, V_nom_kV=9.5, nominal_operating_point=nom_op, 
                              X_d_u=1.205889203, X_q_u=0.661362922, R_a=0.002773253)

sat_model = LinearSaturationModel(gen_data, nom_operating_point=nom_op)

trafo_data = TransformerDataclass(S_nom, 9.5, 23.0, 0.04, 0.003, 0.003, 0.001, 1.0, 0.5)
