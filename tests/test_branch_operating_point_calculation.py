...
class TestGeneratorBranchResults(unittest.TestCase):
    def setUp(self):
        ...
        self.op1 = BranchOperatingPoint(P_mw=24.793686423, Q_mvar=-2.052793948, V_pu=1.0) 
        self.op2 = BranchOperatingPoint(P_mw=24.763759045, Q_mvar=-2.136307742, V_pu=1.0) 
        self.op3 = BranchOperatingPoint(P_mw=24.795781611, Q_mvar=-1.76737924 , V_pu=1.0) 
        self.op4 = BranchOperatingPoint(P_mw=24.725730924, Q_mvar=-2.551981580, V_pu=1.0) 
        self.op5 = BranchOperatingPoint(P_mw=24.825984243, Q_mvar=-1.374348229, V_pu=1.0) 
        self.op6 = BranchOperatingPoint(P_mw=24.808756171, Q_mvar=-1.607683499, V_pu=1.0) 
        self.op7 = BranchOperatingPoint(P_mw=24.763759044, Q_mvar=-2.136307742, V_pu=1.0) 
        self.op8 = BranchOperatingPoint(P_mw=24.731010813, Q_mvar=-2.495154196, V_pu=0.92) 
        self.op9 = BranchOperatingPoint(P_mw=24.771259162, Q_mvar=-2.052037273, V_pu=0.92)  
